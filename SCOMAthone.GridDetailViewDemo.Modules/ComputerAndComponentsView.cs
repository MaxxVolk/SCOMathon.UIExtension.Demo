...
{
  public partial class ComputerAndComponentsView : GridViewBase<InstanceState, StateQuery>, IParentView
  {
    /// <summary>
    ...
    private Dictionary<HealthState, Image> HealthStateImages;
    private Dictionary<HealthState, string> HealthStrings;

    /// <summary>
    /// Resource manager to access embedded console resources.
    /// </summary>
    protected ResourceManager ConsoleResources;
    /// <summary>
    /// Current Culture.
    /// </summary>
    protected CultureInfo CurrentCulture = Thread.CurrentThread.CurrentUICulture;

    public ComputerAndComponentsView() : base()
    {
      InitializeComponent();
      Init();
    }

    public ComputerAndComponentsView(System.ComponentModel.IContainer parent, IViewTargetParser parser) : base(parent, parser)
    {
      InitializeComponent();
      Init();
    }

    public ComputerAndComponentsView(IViewTargetParser parser) : base(parser)
    {
      InitializeComponent();
      Init();
    }

    public ComputerAndComponentsView(Guid parentViewId, IViewTargetParser parser) : base(parentViewId, parser)
    {
      InitializeComponent();
      Init();
    }
    ...
    protected ManagementPackClass GetViewClass() => ManagementGroup.EntityTypes.GetClass(ComputerClassId);
    ...
    /// </summary>
    /// <param name="contextMenu">Context menu instance to add items to</param>
    protected void AddUserContextMenu(ContextMenuHelper contextMenu)
    {
    ...
    /// </summary>
    public Type ChildViewType => typeof(ComponentsDisplayControl);
